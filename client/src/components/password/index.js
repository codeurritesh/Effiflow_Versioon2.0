...
const Password = (props) => {
  ...
  return <div className={`password-component ${isError ? 'error' : ''}`}>
    <div className="password-wrapper">
      ...
      <input minLength={4} className="password-input" type={showPwd ? "text" : "password"} value={props.value} onFocus={onFocusPassword} onBlur={onBlurPassword} onChange={onChangePassword} {...rest} />
